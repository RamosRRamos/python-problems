...
class TestSplitAndJoin(unittest.TestCase):
    ...
    def test_split_and_join(self):
        """
               Here, we import the split_and_join() function from a separate
               file called split_and_join.py.
               Then, we write a unittest test case called TestSplitAndJoin
               which inherits from unittest.TestCase.
               Within the test case, we define a test method called
               test_split_and_join() which includes
               two assertions that verify if the function returns the expected
